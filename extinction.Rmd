...
my_sim.base  <- setParameter(my_sim.base,"dispersal_rate",0.1)
...
print(computed.rate)
stopifnot(sum(Qn ==0) > qbinom(0.005,999*100,0.05))
stopifnot(sum(Qn ==0) < qbinom(0.995,999*100,0.05))
```
...
print(computed.rate)
stopifnot(sum(Qn == 10) > qbinom(0.005,999*100,0.05))
stopifnot(sum(Qn == 10) < qbinom(0.995,999*100,0.05))
```
