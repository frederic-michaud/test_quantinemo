...
my_sim.base = new("simulation",sim.dir = "pop_grow/",parameters=list("generations" = 1000, "patch_capacity" = 1000,"stat" = "{adlt.nbInd}"))
```
...
stopifnot(abs(log(pop.sim)-log(pop.exp))<1.5)
