...
for (patch in 1:n.patch) {
  ...
  stopifnot(sd(final.distrib)>20) #Testing with the R version, it's a cut at about 5%
  stopifnot(sd(final.distrib)<2500) #Testing with the R version, it's a cut at about 5%
```
